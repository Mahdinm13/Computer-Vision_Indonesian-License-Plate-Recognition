    ...
    def process(self):
        ...
        for txt_file in txt_files:
            ...
            try:
                ...
                logging.warning(f"⚠ Gagal memproses {txt_file}: {e}")
        ...
        with open(txt_path, "r", encoding="utf-8") as file:
            for line_num, line in enumerate(file, start=1):
                ...
                try:
                    ...
                    logging.warning(f"  ⚠ Error parsing di {os.path.basename(txt_path)} baris {line_num}: {e}")
        return result
...
if __name__ == "__main__":
    dataset_path = r"C:\Users\ASUS\Downloads\Mahdi\Semester_6\UAS\Plat\test"  # <- ubah ke direktori datasetmu
